...
ua = load_dataset('csv', data_files={'train': args.train_data, 'evde':args.test_data}, cache_dir="large_cache_1")# .shuffle(seed=42)
...
trainer = Trainer(
    ...
    train_dataset=ua['train'],
    eval_dataset=ua['evde'],
